package alternativa.gui.mouse {
	...
	public class Cursor extends Sprite implements IKeyboardListener {
		 ...
		 */		
		private static var _keyFiltersConfig:KeyFiltersConfig;
		
		protected static var escFilter:SimpleKeyFilter;
		protected static const KEY_ACTION_CANCEL_DRAG:String = "CursorCancelDrag";
		
		private static var GUIcursorEnabled:Boolean;
		...
		public static function init(stage:Stage, GUIcursorEnabled:Boolean = false, parent:DisplayObjectContainer = null):void {
			Cursor.GUIcursorEnabled = GUIcursorEnabled;
		...
		public static function change(id:uint):void {
			if (!instance.locked && Cursor.GUIcursorEnabled) {
		 ...
		 */		
		private static function arrangeOveredTree(overObject:ICursorActive):Array {
		 ...
		 */		
		private static function getDifferenceTree(tree1:Array, tree2:Array):Array {
		...
		private function onMouseDown(e:MouseEvent):void {
			...
			if (pressed != null) {
				// Смена фокуса
				GUI.focusManager.focus = DisplayObject(pressed);
		...
		private function onStartDrag(e:MouseEvent):void {
			...
			if (dist > dragEnableDistance) {
				...
				//if (IOInterfaces.keyboardAvailable) {
					...
					GUI.keyboardManager.addKeyboardListener(this);
				//}
		...
		private function onDrop(e:MouseEvent = null):void {
			...
			//if (IOInterfaces.keyboardAvailable) {
				GUI.keyboardManager.removeKeyboardListener(this);
