package alternativa.tanks.loader {
	...
	public class LoadingProgressBar	extends Sprite {
		...
		[Embed(source="resource/images/progressbar_back_fill.png")] private static const backFillBitmap:Class;
		private static const backFillBd:BitmapData = new backFillBitmap().bitmapData;
		[Embed(source="resource/images/progressbar_fill.png")] private static const fillBitmap:Class;
