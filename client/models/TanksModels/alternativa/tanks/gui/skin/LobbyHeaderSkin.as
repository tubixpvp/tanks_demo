package alternativa.tanks.gui.skin {
	...
	public class LobbyHeaderSkin extends LabelSkin	{
		...
		public function LobbyHeaderSkin() {
			super(LobbyHeaderSkin.tfNormal,
			 	  LobbyHeaderSkin.tfLocked,
			 	  new Array(),
			 	  new Array(),
			 	  LobbyHeaderSkin.thickness,
			 	  LobbyHeaderSkin.sharpness);
		}
