package alternativa.tanks.gui.skin {
	...
	public class LoginShortInputSkin extends InputSkin {
		
		[Embed(source="../../resources/login-short-input_nl.png")] private static const bitmapNL:Class;
		[Embed(source="../../resources/login-short-input_nc.png")] private static const bitmapNC:Class;
		[Embed(source="../../resources/login-short-input_nr.png")] private static const bitmapNR:Class;
		...
		public function LoginShortInputSkin() {
			super(  LoginShortInputSkin.bmpNL,
					LoginShortInputSkin.bmpNC,
					LoginShortInputSkin.bmpNR,
					LoginShortInputSkin.bmpNL,
					LoginShortInputSkin.bmpNC,
					LoginShortInputSkin.bmpNR,
					LoginShortInputSkin.bmpNL,
					LoginShortInputSkin.bmpNC,
					...
					LoginShortInputSkin.bmpNC,
					LoginShortInputSkin.bmpNR,
					LoginShortInputSkin.borderThickness,
					LoginShortInputSkin.topMargin,
					LoginShortInputSkin.leftMargin,
					LoginShortInputSkin.rightMargin,
					LoginShortInputSkin.thickness,
					LoginShortInputSkin.sharpness,
					LoginShortInputSkin.tfNormal,
					LoginShortInputSkin.tfLocked);		
		}
