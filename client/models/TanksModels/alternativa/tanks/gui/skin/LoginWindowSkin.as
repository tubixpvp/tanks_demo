package alternativa.tanks.gui.skin {	
	...
	public class LoginWindowSkin extends WindowSkin {
		...
		*/
		...
		private static const containerMargin:int = 0;
		...
		public function LoginWindowSkin() {
			super(LoginWindowSkin.cornerTL,
				  LoginWindowSkin.cornerTLactive,
				  LoginWindowSkin.cornerTLmargin,
				  LoginWindowSkin.cornerTR,
				  LoginWindowSkin.cornerTRactive,
				  LoginWindowSkin.cornerTRmargin,
				  LoginWindowSkin.cornerBL,
				  LoginWindowSkin.cornerBR, 
				  LoginWindowSkin.edgeTC,
				  LoginWindowSkin.edgeTCactive,
				  LoginWindowSkin.edgeML,
				  LoginWindowSkin.edgeMR,
				  LoginWindowSkin.edgeBC,
				  LoginWindowSkin.bgMC,
				  LoginWindowSkin.closeNormal,
				  LoginWindowSkin.closeNormal,
				  LoginWindowSkin.closeActive,
				  LoginWindowSkin.closeActive,
				  LoginWindowSkin.minimizeNormal,
				  LoginWindowSkin.minimizeNormal,
				  LoginWindowSkin.minimizeActive,
				  LoginWindowSkin.minimizeActive,
				  LoginWindowSkin.maximizeNormal,
				  LoginWindowSkin.maximizeNormal,
				  LoginWindowSkin.maximizeActive,
				  LoginWindowSkin.maximizeActive,
				  LoginWindowSkin.restoreNormal,
				  LoginWindowSkin.restoreNormal,
				  LoginWindowSkin.restoreActive,
				  LoginWindowSkin.restoreActive,
				  LoginWindowSkin.containerMargin,
				  LoginWindowSkin.titleMargin,
				  LoginWindowSkin.titleSpace,
				  LoginWindowSkin.controlButtonMarginLeft,
				  LoginWindowSkin.controlButtonMarginTop,
				  LoginWindowSkin.controlButtonMarginRight,
				  LoginWindowSkin.controlButtonSpace,
				  LoginWindowSkin.borderThickness);
		}	
