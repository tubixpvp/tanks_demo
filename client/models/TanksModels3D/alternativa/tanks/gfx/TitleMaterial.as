package alternativa.tanks.gfx {
	 ...
	 */
	public class TitleMaterial extends SpriteMaterial {
		 ...
		 */
		public function TitleMaterial(texture:Texture, alpha:Number = 1, smooth:Boolean = false, blendMode:String = BlendMode.NORMAL, originX:Number = 0.5, originY:Number = 0.5) {
		...
		override alternativa3d function canDraw(camera:Camera3D):Boolean {
			...
			if (camera._orthographic) {
				...
				w = _texture._width*_sprite._materialScale;
				h = _texture._height*_sprite._materialScale;
		...
		override public function clone():Material {
			return new TitleMaterial(_texture, _alpha, _smooth, _blendMode, _originX, _originY);
		}
